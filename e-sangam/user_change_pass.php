...
$encrypted = encryptIt($confirm_pass);
			...
			$sql="update login_tb set pass='$encrypted' where type='3' and login_id='$id'";
  ...
  <br>
    ...
    <div class="row">
			...
			<div class="col-md-7 offset-1 padd">
				<input  type="text"  name="new_pass" class="form-control" placeholder="NEW PASSWORD" onchange="pass()" required />
			</div>
				<div class="col-md-7 offset-1 padd">
