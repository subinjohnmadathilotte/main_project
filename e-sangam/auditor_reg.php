  ...
  <br>
    ...
    <div class="row">
		...
		<tr>
			...
			<input  type="text"  name="f_name" class=" form-control" required ></td>
		</tr>
		
				<tr>
		    <td class="td_pad">Last name</td><td class="td2_pad">
			<input  type="text"  name="l_name" class=" form-control" required ></td>
		</tr>
		...
		<tr>
			...
			<input type="date" value="1995-01-01"  name="dob" class=" form-control" required ></td>
		</tr>

		<tr>
		    <td class="td_pad">House name</td><td class="td2_pad">
			<input  type="text"  name="h_name" class=" form-control" required ></td>
		</tr>
		
		<tr>
		    <td class="td_pad">Pin</td><td class="td2_pad">
			<input  type="text"  name="pin" class=" form-control" required ></td>
		</tr>
		...
		<tr>
			...
			<input  type="text"  name="ph_no" class=" form-control" required ></td>
			</tr>

			<tr>
		    <td class="td_pad">Email  </td><td class="td2_pad">
			<input  type="text"  name="email" class=" form-control" required ></td>
			</tr>
			
			<tr>
		    <td class="td_pad">Password  </td><td class="td2_pad">
			<input  type="text"  name="password" class=" form-control" required ></td></tr>
			
			<tr>
		    <td class="td_pad">confirm password  </td><td class="td2_pad">
			<input  type="text"  name="c_password" class=" form-control" required ></td></tr>
